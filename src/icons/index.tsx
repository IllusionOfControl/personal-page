...
const mapIconWithComponent: Record<string, IconComponentType> = {
  // Local JSX icons
  react: ReactIcon,
  redux: ReduxIcon,
  nextjs: NextJsIcon,
  ...
  // React-icons
  python: (props) => (
    <SiPython className="text-amber-400" size={props.width || 24} {...props} />
  ),
  golang: (props) => (
    <SiGo className="text-cyan-400" size={props.width || 24} {...props} />
  ),
  go: (props) => (
    <SiGo className="text-cyan-400" size={props.width || 24} {...props} />
  ),
  ...
  celery: (props) => (
    <SiCelery className="text-green-400" size={props.width || 24} {...props} />
  ),
  rabbitmq: (props) => (
    <SiRabbitmq
  ...
  minio: (props) => (
    <SiMinio className="text-pink-500" size={props.width || 24} {...props} />
  ),
  sqlite: (props) => (
    <SiSqlite className="text-sky-400" size={props.width || 24} {...props} />
  ),
  langchain: (props) => (
    <SiLangchain
  ...
  aws: (props) => (
    <FaAws className="text-amber-500" size={props.width || 24} {...props} />
  ),
  cplusplus: (props) => (
    <SiCplusplus
  ...
  rust: (props) => (
    <SiRust className="text-orange-400" size={props.width || 24} {...props} />
  ),
  nodejs: (props) => (
    <SiNodedotjs
  ...
  ai: (props) => (
    <FaBrain className="text-rose-400" size={props.width || 24} {...props} />
  ),
  llm: (props) => (
    <FaRobot className="text-purple-400" size={props.width || 24} {...props} />
  ),
  server: (props) => (
    <FaServer
