                  ...
                  <div className="flex flex-col">
                    <div
                      ...
                      <Image src={project.img} alt="Portfolio" width={700} height={700}
                             className="absolute h-full w-full z-10 rounded-t-xl object-cover object-top"/>
                    </div>
                    <div className="h-fit p-5 space-y-3">
                      <div className="flex items-center justify-between space-x-3">
                        <p className="text-lg font-bold text-primary">{project.title}</p>
                        <div className="flex space-x-4 text-3xl">
                          {project.links.github && (<Link href={project.links.github} className="hover:text-rose-800 transition-colors"><FaGithub/></Link>)}
                          {project.links.demo && (<Link href={project.links.demo} className="hover:text-rose-800 transition-colors"><FaLink/></Link>)}
                        </div>
                      </div>
