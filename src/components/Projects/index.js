  ...
  return (
    <section className="bg-neutral-900">
      <div
        ...
        <ul className="sm:pt-24 grid grid-cols-2 gap-8">
          {projects.map((project, i) => {
            return (
              <li key={i} className="rounded-md border shadow-md border-neutral-700 hover:border-rose-900 transition-colors">
                <div
                  ...
                  <div className="flex flex-col flex-grow h-fit p-5 space-y-3">
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex space-x-4 text-3xl">
                          {project.links.github && (<Link href={project.links.github} className="hover:text-rose-700 transition-colors"><FaGithub/></Link>)}
                          {project.links.demo && (<Link href={project.links.demo} className="hover:text-rose-700 transition-colors"><FaLink/></Link>)}
                        </div>
                      </div>
