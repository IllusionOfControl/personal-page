...
const cvPdfUrl =
  "https://drive.google.com/file/d/17oqcjAg94V_Kgj7geIr3CN2pF_QDLGsr/view?usp=share_link";
...
const projects = [
  ...
  },
  {
    ...
    description:
      "Todoist is a web service and a set of task management software. This project implements a copy of it.",
    links: {
  ...
  },
  {
    ...
    description:
      "The device displays system information about the status of the computer: " +
  ...
  },
  {
    ...
    description:
      "An educational project that allows you to catalog books by author, book series, publisher and tags. " +
  ...
  },
  {
    ...
    description:
      "This is a Golang Telegram bot that can pixilize images. " +
  ...
  },
  {
    ...
    stack: ["Golang", "FFmpeg"],
    description:
      "Coub-dl is a Go application that allows you to download videos from the coub.com",
    links: {
  ...
  },
  {
    ...
    stack: ["Python", "Flask"],
    description:
      "Personal project for organization torrent files, that used Bencode parser.",
    links: {
